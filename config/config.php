 ...
 */
define("DB_HOST", "mysql01.dextramapping.hospedagemdesites.ws");
define("DB_NAME", "dextramapping");
define("DB_USER", "dextramapping");
define("DB_PASS", "Dextra2015");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://dextramapping.servicos.ws/register.php");
define("EMAIL_PASSWORDRESET_FROM", "noreply@dextra.services");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Dextra Mapping");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Dextra Mapping");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://dextramapping.servicos.ws/register.php");
define("EMAIL_VERIFICATION_FROM", "noreply@dextra.services");
define("EMAIL_VERIFICATION_FROM_NAME", "Dextra Mapping");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Dextra Mapping");
