        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
					<li><a href="javascript:void(0)"><?php echo WORDING_YOU_ARE_LOGGED_IN_AS . htmlspecialchars($_SESSION['user_name']); ?></a></li>		
					<li><a href="index.php?logout" id="hdr-btn-logout"><?php echo WORDING_LOGOUT; ?></a></li>					
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </nav>
	...
	<div id="tabs" class="tabs open" role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist" id="list-options">
            <li role="presentation" id="li-map" class="active">
                <a href="javascript:void(0)" id="btn-map" aria-controls="tab-latest" role="tab" data-toggle="tab">Mapa</a>
            </li>
            <li role="presentation" id="li-investigations">
                <a href="#enter-details-tab" id="btn-controls" aria-controls="tab-latest" role="tab" data-toggle="tab">Configurações</a>
            </li>		
        </ul>	
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="enter-details-tab">
                <div class="row box sidebar-header-container">
                    ...
                    <h1 class="sidebar-header">DEXTRA MAPPING</h1>
                </div>
                    <div class="row box">
                        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                            <span class="fill-message"><strong>CONFIGURAÇOES</strong></span>
                        </div>
                        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
	...
	<script>
	    ...
	    $("#btn_export").on("click", function(){
		    if(dextraMap.getMode()){
				...
				dextraMap.downloadCSV({advanced: true, filename: "sites_towers_export.csv"});
			}
			else
			{
